    ...
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <div class="container mx-auto mt-24">
            <h1 class="text-3xl font-bold mb-6">
                <img class="float-left px-2 py-4 w-full" src="/img/<?= $post['img'] ?>" alt="Girl in a jacket">
                <br>
        ...
        <div class="col-start-3  gap-4 flex justify-end">
            <p class="">
            <form method="POST" action="delete">
                <input type="hidden" name="_method" value="DELETE">
                <input type="hidden" name="id" value="<?= $post['id'] ?>">
                <button class="text-white-500 py-2 px-4 rounded-md bg-red-500">Delete</button>
            </form>
            <a href="/blog/edit?id=<?= $post['id'] ?>" class="text-white-500  py-2 px-4 rounded-md bg-blue-500">Edit</a>
            </p>
        </div>
    </div>
</main>
