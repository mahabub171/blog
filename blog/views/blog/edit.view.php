            ...
            <form method="POST" action="/update">
                ...
                <div class="flex justify-between">
                    <div>
                        ...
                        <br>
                        <input type="file" id="img" name="img" accept=" .jpg, .jpeg, .png" value="<?= $post['img'] ?>">
                    </div>
                    <!-- <div>
                    ...
                    <div>
                        <?php $status = isset($_POST['post_status']);
                        if ($status == "Publish") { ?>
                            <div class="relative max-w-sm">
                ...
                <div class="text-3xl font-bold">
                    <input class="my-3 px-2" type="text" name="title" placeholder="title" value="<?= $post['title'] ?>">
                </div>
                ...
                <br>
                <div>
                    <textarea class="my-3 px-2" rows="6" cols="50" name="content" placeholder="content"><?= $post['content'] ?></textarea>
                ...
                <div class="col-start-3 flex justify-end">
                    <p class="py-6">
                        <a href="/blog" class="text-white-500 py-2 px-4 rounded-md bg-gray-500">Cancel</a>
                ...
                <div>
                    <input class="py-2 px-4 rounded-md bg-green-500" type="submit" name="save" value="update">
                </div>
            </form>
        </div>
    </div>
